        ...
        <div class="item">
          ...
          <div class="container">
            <div class="carousel-caption">
                ...
                <div class="item">
          <img class="third-slide" src="{{ asset('img/easytrips.jpeg') }}" alt="Third slide">
          <div class="container">
            <div class="carousel-caption">
            </div>
          </div>
...
<div id="myCarousel" class="carousel slide visible-xs" data-ride="carousel">
        ...
        <div class="item">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <div class="item">
          <img class="fourth-slide" src="{{ asset('img/6-mobile.jpg') }}" alt="Fourth slide">
          <div class="container">
            <div class="carousel-caption">
            </div>
          </div>
      ...
      <div class="item">
        ...
        <div class="item">
          <img class="fifth-slide" src="{{ asset('img/4-mobile.jpeg') }}" alt="Fifth slide">
          <div class="container">
            <div class="carousel-caption">
            </div>
          </div>
